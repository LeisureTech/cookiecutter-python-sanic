...
The best way to send feedback is to file an issue at https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.package-name }}/issues.
...
3. The pull request should work for Python 3.7, 3.8, 3.9, and for PyPy. Check
   https://travis-ci.com/{{ cookiecutter.github_username }}/{{ cookiecutter.package_name }}/pull_requests
...
$ semantic-release --patch publish # possible: major / minor / patch
$ git push
$ git push --tags
